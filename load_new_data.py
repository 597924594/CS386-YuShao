...
for i in range(0, 600):
    nodule_48 = lkds_nodule[i][40:88,40:88,40:88]
    mask_48 = lkds_mask[i][40:88,40:88,40:88]*255.
    print mask_48
    for j in range(len(mask_48)):

        # mask_48[j] = np.array(mask_48[j], dtype=np.uint8)
        mask_48[j]=cv2.GaussianBlur_self_fit(mask_48[j])/255.
    np.savez('./lkds_0724/'+str(i+1)+".npz", module=nodule_48, mask=mask_48)
